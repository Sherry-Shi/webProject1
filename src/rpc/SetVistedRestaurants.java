...
/**
 * Servlet implementation class SetVistedRestaurants
 */
@WebServlet("/SetVistedRestaurants")
public class SetVistedRestaurants extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SetVistedRestaurants() {
        super();
